...
const news = [
  ...
  },
  {
    ...
    publisher: "Sahil Mohite",
    image: {
      uri: "https://images.unsplash.com/photo-1519389950473-47ba0277781c?auto=format&fit=crop&w=800&q=80",
    },
  },
  {
    ...
    publisher: "Sahil Mohite",
    image: {
      uri: "https://images.unsplash.com/photo-1462331940025-496dfbfc7564?auto=format&fit=crop&w=800&q=80",
    },
  },
];
          ...
          renderItem={({ item }) => (
            <View style={styles.card}>
              ...
              <View style={styles.overlay}>
                <Text style={styles.overlaypublisher}>{item.categgory}</Text>
                <Text style={styles.overlayTitle}>{item.title}</Text>
                <Text style={styles.overlaypublisher}>{item.publisher}</Text>
              </View>
            </View>
          )}
        />
